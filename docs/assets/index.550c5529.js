    ...
    switch (this.signInMethod) {
      case "password":
        ...
        if ((_a2 = auth._getRecaptchaConfig()) === null || _a2 === void 0 ? void 0 : _a2.emailPasswordEnabled) {
          ...
          return signInWithPassword$1(auth, requestWithRecaptcha);
        } else {
          return signInWithPassword$1(auth, request).catch(async (error) => {
...
const Register = () => {
  ...
  div.innerHTML = `
  <picture>
  <source media="(max-width: 600px)" srcset="${logoPrincipal}">
  <img src="${iconoNavegador}" alt="Descripci\xF3n de la imagen" class="icono-register">
</picture>
...
const Login = () => {
  ...
  <img src="${logo1}" alt="Descripci\xF3n de la imagen" class="logoForm">
  </picture>
  <form id="loginForm" class="loginForm">
  <button class="google-btn">
  <div class="contenido-google">
  <span>
  <img class="icono-google" src="${google}">
  </span>
...
const Home = () => {
  ...
  div.innerHTML = `
    <header class="header-muro">
      <img class="img-logo" src="${logoPrincipal}">
      <h1>Wanderlust</h1>
      <img class="btnCerrarSesion" src="${logOutIcon}" alt="Cerrar sesi\xF3n">
    </header>
